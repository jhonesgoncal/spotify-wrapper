...
[![Build Status](https://travis-ci.org/jhonesgoncal/spotify-wrapper.svg?branch=master)](https://travis-ci.org/jhonesgoncal/spotify-wrapper) [![Coverage Status](https://coveralls.io/repos/github/jhonesgoncal/spotify-wrapper/badge.svg?branch=master)](https://coveralls.io/github/jhonesgoncal/spotify-wrapper?branch=master)
...
```sh
$ npm install jg-spotify-wrapper --save
```
...
See also the list of [contributors](https://github.com/jhonesgoncal/spotify-wrapper/contributors) who participated in this project.
